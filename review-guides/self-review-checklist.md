...
## G. 七问闭环 + 决策追溯 + 复杂度分流自检（v0.5 新增 · 对应 A1 卡点 + 决策链日志化）

> 本类是 v0.5 新增，目的是防止七问某项在 Phase 0-6 中被永久遗忘，和 Agent 替客户做的默认值决策无迹可循。
...
- [ ] **G8** 治理越权自检（v0.7 新增 · 对应 SKILL.md §5 技术-治理边界 α 严格版）：
...
- [ ] **G9** 证书时代背景自检（v0.7 新增 · 对应 SKILL.md §2 证书有效期时代背景）：
...
- [ ] **G10** 交付产物落盘自检（v0.8 新增 · 对应 SKILL.md §6 交付产物落盘原则）：
...
- [ ] **G11** CSR 生成策略三档选项自检（v0.9 新增 · 对应 SKILL.md §8.3 与 references/csr-persona-talks.md）：
...
- [ ] **G14** 基础设施拓扑识别 + 通配符证书子域名盘点自检（v0.9.3 新增 · 对应 references/topology-detection.md + references/wildcard-inventory.md）：
...
- [ ] **G15** 证书链完整性与多客户端兼容性自检（v0.9.4 新增 · 对应 references/cert-chain-verification.md）：
...
- [ ] **G12** 合规话术边界自检（v0.9 新增 · 修正 v0.7 过度断言）：
  - 交付物中是否包含以下**事实错误话术**？
...
- 治理越权自检 ✅（G8，v0.7 新增）
- 证书时代背景自检 ✅（G9，v0.7 新增）
- 交付产物落盘自检 ✅（G10，v0.8 新增）
- CSR 三档选项自检 ✅（G11，v0.9 新增）
- 合规话术边界自检 ✅（G12，v0.9 新增）
- 多选项中性化自检 ✅（G13，v0.9.1 新增）
- 基础设施拓扑识别自检 ✅（G14，v0.9.3 新增）
- 证书链完整性与多客户端兼容性自检 ✅（G15，v0.9.4 新增）
