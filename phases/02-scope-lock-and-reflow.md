...
## 1. Scope Lock Ceremony（范围锁定仪式 · v0.5 新增 · 解决 C8 卡点）
...
## 4. 客户侧证书资产全景扫描选项（v0.5 新增 · 解决 C9 卡点）
...
## 6. 绑定点（binding）的统一定义（v0.5 新增 · 解决 C6 卡点）
...
## 7. cert_role（证书角色）维度（v0.5 新增 · 解决 E3 卡点）
...
> 📌 **v0.5 起 Phase 1 盘点应明示 cert_role**，避免默认假设"1 证书 1 部署"。
...
- [`../SKILL.md § 0.1`](../SKILL.md) — SAN 闭包发现根本定义
- [`03-risk-assessment-playbook.md`](./03-risk-assessment-playbook.md) — 风险评估接受资产分类输入
- [`capability-matrix.md`](./capability-matrix.md) — 资产分类 / cert_role 维度登记处
