...
## 1. 六维风险扫描框架（v0.5 新增 · 解决 B3/C10 卡点）
...
## 3. 跨 zone DCV 方式矩阵（v0.5 新增 · 解决 D13 卡点）
...
## 4. 硬阻塞风险的兜底方案树（v0.5 新增 · 解决 D14 卡点）
...
## 5. 客户拒绝推荐的优雅降级（v0.5 新增 · 解决 D5 卡点）
...
## 6. 资产分类 → 风险权重（v0.5 新增 · 配合 02-scope-lock-and-reflow.md §5）
...
## 8. Fast Path 的风险评估简化（v0.5 新增 · 解决 E5 卡点）
...
- [`../SKILL.md § 2.1`](../SKILL.md) — 四段式推荐协议（本文件 §5 扩展了拒绝后的降级）
- [`capability-matrix.md`](./capability-matrix.md) — 合规维度登记处
