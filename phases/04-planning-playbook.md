...
## 2. 硬约束过滤器（v0.5 新增 · 解决 B5 卡点 · 对接 03-risk-assessment-playbook.md §2）
...
## 4. "复用客户已有技术栈"优先级原则（v0.5 新增 · 解决 C11 卡点）
...
## 5. Decision Brief（决策简报）格式（v0.5 新增 · 解决 D12 卡点）
...
## 7. Fast Path Runbook 模板（v0.5 新增 · 解决 E7 卡点）
...
## 8. 跨字段综合判断（v0.5 新增 · 解决 A5 卡点）

骨架 § 2.1 的四段式推荐支持"字段独立"；v0.5 增加**"跨字段综合判断"**模式：
