...
## 4. 回滚触发器分级（v0.5 新增 · 解决 B14/B15 卡点）
...
## 6. TTL 对齐验证时刻表（v0.5 新增 · 解决 D17 卡点）
...
## 7. 降级路径（Fallback Mode Switching · v0.5 新增 · 解决 C14 卡点）
...
## 8. 短周期证书的过渡期公式（v0.5 新增 · v0.7 按 CA/B Forum 新节奏重构）
...
## 11. 证书链完整性与客户端兼容性核查（v0.9.4 新增 · 硬项）
